...
***********************************************************************************************************************/
  ...
  extern UINT8 tss_u8HWTimerFlag;  /* Extern variable flag that tereminates if there is been a timeout fault */
  ...
  #define TSS_HW_TIMER_IS_MTIM          (TSS_MTIM_HW_TIMER_USED || TSS_MTIM1_HW_TIMER_USED || TSS_MTIM2_HW_TIMER_USED || TSS_MTIM3_HW_TIMER_USED || TSS_MTIM4_HW_TIMER_USED)
  ...
  *******************************************************/
  ...
  /* QD4 exception */
      ...
      #if (TSS_HW_TIMER_CHK(TSS_HW_TIMER) == TPM1SC_CHK)
        #undef TSS_HW_TIMER
  ...
  /********* Specific Timer related macros ***********/
    ...
    #define TSS_HW_TIMER_PRESCALE_MASK       0x07U
    #define TSS_HW_TIMER_IE                  0x40U
    #define TSS_HW_TIMER_FLAG                0x80U
    #define TSS_HW_TIMER_ON                  0x08U
    #define TSS_HW_TIMER_OFF                 0xE7U
    #define TSS_HW_TIMER_FLAG_ACK            0x7FU

    #if TSS_KINETIS_MCU
      #define TSS_HW_TIMER_SC                  *(volatile UINT8  *)(TSS_HW_TIMER_ADDRESS+0) 
      #define TSS_HW_TIMER_CNT                 *(volatile UINT16 *)(TSS_HW_TIMER_ADDRESS+1)
      #define TSS_HW_TIMER_MOD                 *(volatile UINT16 *)(TSS_HW_TIMER_ADDRESS+2)
    #else 
      #define TSS_HW_TIMER_SC                  *(volatile UINT8  *)(TSS_HW_TIMER_ADDRESS+0) 
      #define TSS_HW_TIMER_CNT                 *(volatile UINT16 *)(TSS_HW_TIMER_ADDRESS+1)
      #define TSS_HW_TIMER_CNTH                *(volatile UINT8  *)(TSS_HW_TIMER_ADDRESS+1)
      #define TSS_HW_TIMER_CNTL                *(volatile UINT8  *)(TSS_HW_TIMER_ADDRESS+2)
      #define TSS_HW_TIMER_MOD                 *(volatile UINT16 *)(TSS_HW_TIMER_ADDRESS+3)
      #define TSS_HW_TIMER_MODH                *(volatile UINT8  *)(TSS_HW_TIMER_ADDRESS+3)
      #define TSS_HW_TIMER_MODL                *(volatile UINT8  *)(TSS_HW_TIMER_ADDRESS+4)
    #endif
    ...
    #define TSS_HW_TIMER_SET_PRESCALE(x)     (TSS_HW_TIMER_SC = (UINT8)((TSS_HW_TIMER_SC & (~TSS_HW_TIMER_PRESCALE_MASK)) | (x)))   /*Changed due to MISRA*/
    #define TSS_HW_TIMER_ENABLE_INT()        (TSS_HW_TIMER_SC |= TSS_HW_TIMER_IE)
    #define TSS_HW_TIMER_DISABLE_INT()       TSS_HW_TIMER_SC &= !TSS_HW_TIMER_IE
    #define TSS_HW_TIMER_SET_MOD(x)          (TSS_HW_TIMER_MOD = x)
    #define TSS_HW_TIMER_GET_MOD()           TSS_HW_TIMER_MOD
    #define TSS_HW_TIMER_START()             (TSS_HW_TIMER_SC |= TSS_HW_TIMER_ON)
    #define TSS_HW_TIMER_STOP()              (TSS_HW_TIMER_SC &= TSS_HW_TIMER_OFF)
    #define TSS_HW_TIMER_RESET()             (TSS_HW_TIMER_CNT = 0x0000U)
    #define TSS_HW_TIMER_GET_LOWCNT()        TSS_HW_TIMER_CNTL             
    #define TSS_HW_TIMER_GET_HICNT()         TSS_HW_TIMER_CNTH             
    #define TSS_HW_TIMER_GET_CNT()           TSS_HW_TIMER_CNT

    #define TSS_HW_TIMER_CLEARFLAG()         TSS_HW_TIMER_SC &= TSS_HW_TIMER_FLAG_ACK;
    #define TSS_HW_TIMER_OVF_FLAG()          (TSS_HW_TIMER_SC & TSS_HW_TIMER_FLAG)
