...
***********************************************************************************************************************/
  ...
  /***************************** Types ***************************/
    ...
    typedef struct {
      volatile UINT8 tsi_u8EndOfScanCounter;
  ...
  */                           
  ...
  extern const UINT8 u8RefChrgCalcTable[8][8];
  
  /************************ TSI Specfic Settings *********************/    
  ...
  #endif
  #ifndef TSS_TSI_SCANC_EXTCHRG_LOW_LIMIT
    #define TSS_TSI_SCANC_EXTCHRG_LOW_LIMIT    0 /* Low Limit of External OSC Charge Current value for TSI autocalibration */
  #endif
  #ifndef TSS_TSI_SCANC_EXTCHRG_HIGH_LIMIT
    #define TSS_TSI_SCANC_EXTCHRG_HIGH_LIMIT   31 /* High Limit of External OSC Charge Current value for TSI autocalibration */
  #endif
  #ifndef TSS_TSI_GENCS_PS_LOW_LIMIT
    #define TSS_TSI_GENCS_PS_LOW_LIMIT    0 /* Low Limit of External OSC Prescaler register value for TSI autocalibration */
  #endif
  #ifndef TSS_TSI_GENCS_PS_HIGH_LIMIT
  ...
  #if (TSS_TSI_SCANC_EXTCHRG_LOW_LIMIT  > 31)
      #error "TSS - TSS_TSI_SCANC_EXTCHRG_LOW_LIMIT is out of range"
  #endif
  
  #if (TSS_TSI_SCANC_EXTCHRG_HIGH_LIMIT > 31)
      #error "TSS - TSS_TSI_SCANC_EXTCHRG_HIGH_LIMIT is out of range"
  #endif

  #if (TSS_TSI_SCANC_EXTCHRG_LOW_LIMIT > TSS_TSI_SCANC_EXTCHRG_HIGH_LIMIT)
      #error "TSS - TSS_TSI_SCANC_EXTCHRG_LOW_LIMIT may not be higher than TSS_TSI_SCANC_EXTCHRG_HIGH_LIMIT"
  #endif

  #if (TSS_TSI_GENCS_PS_LOW_LIMIT  > 7)
      #error "TSS - TSS_TSI_GENCS_PS_LOW_LIMIT is out of range"
  #endif
  
  #if (TSS_TSI_GENCS_PS_HIGH_LIMIT > 7)
      #error "TSS - TSS_TSI_GENCS_PS_HIGH_LIMIT is out of range"
  #endif
  
  #if (TSS_TSI_GENCS_PS_LOW_LIMIT > TSS_TSI_GENCS_PS_HIGH_LIMIT)
      #error "TSS - TSS_TSI_GENCS_PS_LOW_LIMIT may not be higher than TSS_TSI_GENCS_PS_HIGH_LIMIT"
  #endif
  
  #if (TSS_TSI_SCANC_AMCLKS > 2)
      #error "TSS - TSS_TSI_SCANC_AMCLKS is set to invalid value"
  #endif
  
  #if (TSS_TSI_SCANC_AMPSC > 7)
      #error "TSS - TSS_TSI_SCANC_AMPSC is set to invalid value"
  #endif
  
  #if (TSS_TSI_SCANC_AMCLKDIV > 1)
      #error "TSS - TSS_TSI_SCANC_AMCLKDIV is set to invalid value"
  #endif
  
  #if (TSS_TSI_GENCS_LPCLKS > 1)
      #error "TSS - TSS_TSI_GENCS_LPCLKS is set to invalid value"
  #endif
  ...
  #define TSS_TSI_RECALIBRATION_HIGH_THRESHOLD   (0xFFFF - 0xFF)
  ...
  #define TSS_TSI_SCANC_EXTCHRG_RANGE            ((TSS_TSI_SCANC_EXTCHRG_HIGH_LIMIT + 1u) - TSS_TSI_SCANC_EXTCHRG_LOW_LIMIT) 
  
  /******************************** MACROS *************************/    
  
  /* Determination what TSI module is used for later conditional TSI module initialization */
  ...
  *********************************************************************************/
  ...
  #define TSS_TSICH0_PEN_SHIFT            TSI_PEN_PEN0_SHIFT
  #define TSS_TSICH1_PEN_SHIFT            TSI_PEN_PEN1_SHIFT
  #define TSS_TSICH2_PEN_SHIFT            TSI_PEN_PEN2_SHIFT
  #define TSS_TSICH3_PEN_SHIFT            TSI_PEN_PEN3_SHIFT
  #define TSS_TSICH4_PEN_SHIFT            TSI_PEN_PEN4_SHIFT
  #define TSS_TSICH5_PEN_SHIFT            TSI_PEN_PEN5_SHIFT
  #define TSS_TSICH6_PEN_SHIFT            TSI_PEN_PEN6_SHIFT
  #define TSS_TSICH7_PEN_SHIFT            TSI_PEN_PEN7_SHIFT
  #define TSS_TSICH8_PEN_SHIFT            TSI_PEN_PEN8_SHIFT
  #define TSS_TSICH9_PEN_SHIFT            TSI_PEN_PEN9_SHIFT
  #define TSS_TSICH10_PEN_SHIFT           TSI_PEN_PEN10_SHIFT
  #define TSS_TSICH11_PEN_SHIFT           TSI_PEN_PEN11_SHIFT
  #define TSS_TSICH12_PEN_SHIFT           TSI_PEN_PEN12_SHIFT
  #define TSS_TSICH13_PEN_SHIFT           TSI_PEN_PEN13_SHIFT
  #define TSS_TSICH14_PEN_SHIFT           TSI_PEN_PEN14_SHIFT
  #define TSS_TSICH15_PEN_SHIFT           TSI_PEN_PEN15_SHIFT
  
  #define TSS_TSI0CH0_PEN_SHIFT           TSI_PEN_PEN0_SHIFT
  #define TSS_TSI0CH1_PEN_SHIFT           TSI_PEN_PEN1_SHIFT
  #define TSS_TSI0CH2_PEN_SHIFT           TSI_PEN_PEN2_SHIFT
  #define TSS_TSI0CH3_PEN_SHIFT           TSI_PEN_PEN3_SHIFT
  #define TSS_TSI0CH4_PEN_SHIFT           TSI_PEN_PEN4_SHIFT
  #define TSS_TSI0CH5_PEN_SHIFT           TSI_PEN_PEN5_SHIFT
  #define TSS_TSI0CH6_PEN_SHIFT           TSI_PEN_PEN6_SHIFT
  #define TSS_TSI0CH7_PEN_SHIFT           TSI_PEN_PEN7_SHIFT
  #define TSS_TSI0CH8_PEN_SHIFT           TSI_PEN_PEN8_SHIFT
  #define TSS_TSI0CH9_PEN_SHIFT           TSI_PEN_PEN9_SHIFT
  #define TSS_TSI0CH10_PEN_SHIFT          TSI_PEN_PEN10_SHIFT
  #define TSS_TSI0CH11_PEN_SHIFT          TSI_PEN_PEN11_SHIFT
  #define TSS_TSI0CH12_PEN_SHIFT          TSI_PEN_PEN12_SHIFT
  #define TSS_TSI0CH13_PEN_SHIFT          TSI_PEN_PEN13_SHIFT
  #define TSS_TSI0CH14_PEN_SHIFT          TSI_PEN_PEN14_SHIFT
  #define TSS_TSI0CH15_PEN_SHIFT          TSI_PEN_PEN15_SHIFT
  
  #define TSS_TSI1CH0_PEN_SHIFT           TSI_PEN_PEN0_SHIFT
  #define TSS_TSI1CH1_PEN_SHIFT           TSI_PEN_PEN1_SHIFT
  #define TSS_TSI1CH2_PEN_SHIFT           TSI_PEN_PEN2_SHIFT
  #define TSS_TSI1CH3_PEN_SHIFT           TSI_PEN_PEN3_SHIFT
  #define TSS_TSI1CH4_PEN_SHIFT           TSI_PEN_PEN4_SHIFT
  #define TSS_TSI1CH5_PEN_SHIFT           TSI_PEN_PEN5_SHIFT
  #define TSS_TSI1CH6_PEN_SHIFT           TSI_PEN_PEN6_SHIFT
  #define TSS_TSI1CH7_PEN_SHIFT           TSI_PEN_PEN7_SHIFT
  #define TSS_TSI1CH8_PEN_SHIFT           TSI_PEN_PEN8_SHIFT
  #define TSS_TSI1CH9_PEN_SHIFT           TSI_PEN_PEN9_SHIFT
  #define TSS_TSI1CH10_PEN_SHIFT          TSI_PEN_PEN10_SHIFT
  #define TSS_TSI1CH11_PEN_SHIFT          TSI_PEN_PEN11_SHIFT
  #define TSS_TSI1CH12_PEN_SHIFT          TSI_PEN_PEN12_SHIFT
  #define TSS_TSI1CH13_PEN_SHIFT          TSI_PEN_PEN13_SHIFT
  #define TSS_TSI1CH14_PEN_SHIFT          TSI_PEN_PEN14_SHIFT
  #define TSS_TSI1CH15_PEN_SHIFT          TSI_PEN_PEN15_SHIFT
  
  
  #define TSS_TSI_CH0_PEN_SHIFT           TSI_PEN_PEN0_SHIFT
  #define TSS_TSI_CH1_PEN_SHIFT           TSI_PEN_PEN1_SHIFT
  #define TSS_TSI_CH2_PEN_SHIFT           TSI_PEN_PEN2_SHIFT
  #define TSS_TSI_CH3_PEN_SHIFT           TSI_PEN_PEN3_SHIFT
  #define TSS_TSI_CH4_PEN_SHIFT           TSI_PEN_PEN4_SHIFT
  #define TSS_TSI_CH5_PEN_SHIFT           TSI_PEN_PEN5_SHIFT
  #define TSS_TSI_CH6_PEN_SHIFT           TSI_PEN_PEN6_SHIFT
  #define TSS_TSI_CH7_PEN_SHIFT           TSI_PEN_PEN7_SHIFT
  #define TSS_TSI_CH8_PEN_SHIFT           TSI_PEN_PEN8_SHIFT
  #define TSS_TSI_CH9_PEN_SHIFT           TSI_PEN_PEN9_SHIFT
  #define TSS_TSI_CH10_PEN_SHIFT          TSI_PEN_PEN10_SHIFT
  #define TSS_TSI_CH11_PEN_SHIFT          TSI_PEN_PEN11_SHIFT
  #define TSS_TSI_CH12_PEN_SHIFT          TSI_PEN_PEN12_SHIFT
  #define TSS_TSI_CH13_PEN_SHIFT          TSI_PEN_PEN13_SHIFT
  #define TSS_TSI_CH14_PEN_SHIFT          TSI_PEN_PEN14_SHIFT
  #define TSS_TSI_CH15_PEN_SHIFT          TSI_PEN_PEN15_SHIFT
  
  #define TSS_TSI0_CH0_PEN_SHIFT          TSI_PEN_PEN0_SHIFT
  #define TSS_TSI0_CH1_PEN_SHIFT          TSI_PEN_PEN1_SHIFT
  #define TSS_TSI0_CH2_PEN_SHIFT          TSI_PEN_PEN2_SHIFT
  #define TSS_TSI0_CH3_PEN_SHIFT          TSI_PEN_PEN3_SHIFT
  #define TSS_TSI0_CH4_PEN_SHIFT          TSI_PEN_PEN4_SHIFT
  #define TSS_TSI0_CH5_PEN_SHIFT          TSI_PEN_PEN5_SHIFT
  #define TSS_TSI0_CH6_PEN_SHIFT          TSI_PEN_PEN6_SHIFT
  #define TSS_TSI0_CH7_PEN_SHIFT          TSI_PEN_PEN7_SHIFT
  #define TSS_TSI0_CH8_PEN_SHIFT          TSI_PEN_PEN8_SHIFT
  #define TSS_TSI0_CH9_PEN_SHIFT          TSI_PEN_PEN9_SHIFT
  #define TSS_TSI0_CH10_PEN_SHIFT         TSI_PEN_PEN10_SHIFT
  #define TSS_TSI0_CH11_PEN_SHIFT         TSI_PEN_PEN11_SHIFT
  #define TSS_TSI0_CH12_PEN_SHIFT         TSI_PEN_PEN12_SHIFT
  #define TSS_TSI0_CH13_PEN_SHIFT         TSI_PEN_PEN13_SHIFT
  #define TSS_TSI0_CH14_PEN_SHIFT         TSI_PEN_PEN14_SHIFT
  #define TSS_TSI0_CH15_PEN_SHIFT         TSI_PEN_PEN15_SHIFT
  
  #define TSS_TSI1_CH0_PEN_SHIFT          TSI_PEN_PEN0_SHIFT
  #define TSS_TSI1_CH1_PEN_SHIFT          TSI_PEN_PEN1_SHIFT
  #define TSS_TSI1_CH2_PEN_SHIFT          TSI_PEN_PEN2_SHIFT
  #define TSS_TSI1_CH3_PEN_SHIFT          TSI_PEN_PEN3_SHIFT
  #define TSS_TSI1_CH4_PEN_SHIFT          TSI_PEN_PEN4_SHIFT
  #define TSS_TSI1_CH5_PEN_SHIFT          TSI_PEN_PEN5_SHIFT
  #define TSS_TSI1_CH6_PEN_SHIFT          TSI_PEN_PEN6_SHIFT
  #define TSS_TSI1_CH7_PEN_SHIFT          TSI_PEN_PEN7_SHIFT
  #define TSS_TSI1_CH8_PEN_SHIFT          TSI_PEN_PEN8_SHIFT
  #define TSS_TSI1_CH9_PEN_SHIFT          TSI_PEN_PEN9_SHIFT
  #define TSS_TSI1_CH10_PEN_SHIFT         TSI_PEN_PEN10_SHIFT
  #define TSS_TSI1_CH11_PEN_SHIFT         TSI_PEN_PEN11_SHIFT
  #define TSS_TSI1_CH12_PEN_SHIFT         TSI_PEN_PEN12_SHIFT
  #define TSS_TSI1_CH13_PEN_SHIFT         TSI_PEN_PEN13_SHIFT
  #define TSS_TSI1_CH14_PEN_SHIFT         TSI_PEN_PEN14_SHIFT
  #define TSS_TSI1_CH15_PEN_SHIFT         TSI_PEN_PEN15_SHIFT
  ...
  #ifndef TSI_THRESHOLD_REG  
    #define THRESHOLD                       THRESHLD 
  #endif

  #ifdef TSS_TSI_DEF_SCANC_AMCLKS
    #ifndef TSS_TSI_SCANC_AMCLKS      
      #define TSS_TSI_SCANC_AMCLKS          TSS_TSI_DEF_SCANC_AMCLKS
    #endif
  #endif
  
  #ifdef TSS_TSI_DEF_SCANC_AMCLKDIV
    #ifndef TSS_TSI_SCANC_AMCLKDIV      
      #define TSS_TSI_SCANC_AMCLKDIV        TSS_TSI_DEF_SCANC_AMCLKDIV
    #endif
  #endif      
  
  #ifdef TSS_TSI_DEF_SCANC_AMPSC
    #ifndef TSS_TSI_SCANC_AMPSC      
      #define TSS_TSI_SCANC_AMPSC           TSS_TSI_DEF_SCANC_AMPSC
    #endif
  #endif      
  
  #ifdef TSS_TSI_DEF_GENCS_LPCLKS
    #ifndef TSS_TSI_GENCS_LPCLKS      
      #define TSS_TSI_GENCS_LPCLKS          TSS_TSI_DEF_GENCS_LPCLKS
    #endif
  #endif      
