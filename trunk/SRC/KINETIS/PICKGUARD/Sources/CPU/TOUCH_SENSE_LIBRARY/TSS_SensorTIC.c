...
#include "TSS_SensorTIC.h"
  ...
  #include "TSS_GPIO.h"
    ...
    /***************** ROM & RAM Data definition ***********************/
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E0_ROMDATA_CONTEXT = {
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E1_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E2_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E3_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E4_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E5_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E6_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E7_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E8_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E9_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E10_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E11_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E12_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E13_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E14_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E15_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E16_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E17_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E18_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E19_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E20_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E21_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E22_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E23_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E24_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E25_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E26_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E27_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E28_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E29_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E30_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E31_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E32_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E33_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E34_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E35_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E36_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E37_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E38_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E39_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E40_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E41_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E42_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E43_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E44_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E45_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E46_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E47_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E48_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E49_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E50_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E51_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E52_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E53_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E54_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E55_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E56_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E57_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E58_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E59_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E60_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E61_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E62_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
        ...
        const TSS_TIC_ELECTRODE_ROMDATA TSS_E63_ROMDATA_CONTEXT = {
                                                                 #if TSS_USE_NOISE_AMPLITUDE_FILTER
    ...
    ****************************************************************************/
        ...
        {
          /* Clear TImer Flag */
          ((TPM_MemMapPtr) tss_psElectrodeTimertAdr)->SC &= TSS_HW_TIMER_FLAG_ACK;         /* Clear Timer Flag */
        ...
        {
          /* Clear TImer Flag */
          ((FTM_MemMapPtr) tss_psElectrodeTimertAdr)->SC &= TSS_HW_TIMER_FLAG_ACK;         /* Clear Timer Flag */
