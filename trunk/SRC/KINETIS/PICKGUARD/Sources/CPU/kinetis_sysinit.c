...
static __declspec(vectortable) tVectorTable __vect_table = { /* Interrupt vector table */
   __SP_INIT,                                              /* 0 (0x00000000) (prior: -) */
  {
   ...
   (tIsrFunc)Uart2_ISR_TX_RX_ISR,                               /* 65 (0x00000104) (prior: -) */
   ...
   (tIsrFunc)ADC0_IRQ,                               /* 73 (0x00000124) (prior: -) */
   (tIsrFunc)ADC1_IRQ,                               /* 74 (0x00000128) (prior: -) */
   ...
   (tIsrFunc)FlexTimer0_Irq,                               /* 78 (0x00000138) (prior: -) */
   ...
   (tIsrFunc)AudioProcess,                               /* 95 (0x0000017C) (prior: -) */
   ...
   (tIsrFunc)TSS_TSI0Isr,                               /* 99 (0x0000018C) (prior: -) */
